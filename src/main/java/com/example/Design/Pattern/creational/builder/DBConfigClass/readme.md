...
**Review the original class -** You have been provided with a class that represents the database configuration DatabaseConfiguration. The class has a number of properties that are used to configure the database connection. Your task is to implement the Builder pattern to create instances of a class with the same properties.

**Implement the builder class -** Implement the class called DatabaseConfigurationBuilder that will implement the builder pattern. Remember the class is annotated with @WithBuilder annotation. The name does not matter as long as it is annotated.

**Test your implementation -** Hidden test case has been provided for you to test your implementation. Click the submit button to run the test cases to ensure that your implementation is correct. This will pick the correct implementation of the builder class based on the @WithBuilder annotation.
